...
if(isset($_POST['submit'])){
   ...
   $insert = mysqli_query($conn, "INSERT INTO `contact_form`(name,age, email, number, date) VALUES('$name','$age','$email','$number','$date')") or die('query failed');
...
<header class="header fixed-top">
   ...
   <div class="container">
      ...
      <div class="row align-items-center justify-content-between">
         ...
         <a href="#home" class="logo">dental<span>Care. Baxshin</span></a>
...
<section class="contact" id="contact">
   ...
   <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
      ...
      <span>Your Age:</span>
      <input type="text" name="age" placeholder="enter your name" class="box" required>
